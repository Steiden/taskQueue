...
class taskQueueOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('taskqueue_item_err_ns');
        }
...
return 'taskQueueOfficeItemUpdateProcessor';
